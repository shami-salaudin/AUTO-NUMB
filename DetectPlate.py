...
plate_dimensions = (0.08*label_image.shape[0], 0.08*label_image.shape[0], 0.15*label_image.shape[1], 0.8*label_image.shape[1])
plate_dimensions2 = (0.08*label_image.shape[0], 0.8*label_image.shape[0], 0.15*label_image.shape[1], 0.8*label_image.shape[1])
